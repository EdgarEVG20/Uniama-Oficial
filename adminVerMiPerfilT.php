                    ...
                    <div class="row">
                        <div class="col">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a href="#BAJA" class="nav-link" role="tab" data-toggle="tab">Baja</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane show active" id="FP">
                                    <div class="divLogo">
                                        ...
                                        <form class="form mt-3 mb-5" action="server/update-tPerfilLogoUsuarios.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <?php
                                                $dataUsuario = mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_empresa = $idEmpresa AND id_usuario = $idVerUsuario");
                                                        ...
                                                        <span class="btn btn-primary btn-file">
                                                            ...
                                                            <br clear="all"><br clear="all">
                                                                <output id="miniaturas">
                                                                    <?php
                                                                    $foto = "Clientes/".$idEmpresa."/empleados/".$idVerUsuario."/imgPerfil/fotoPerfil.png";
                                                                        if (file_exists($foto)) {
                                                                    ?>
                                                                    <img class="fotoPerfilMiniatura" src="Clientes/<?php echo $idEmpresa ?>/empleados/<?php echo $idVerUsuario ?>/imgPerfil/fotoPerfil.png" alt=""><!--_--><?php //echo $rfc ?>
                                                                    <?php
                                                                        } else {
                                                                    ?>
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="IPB">
                                    ...
                                    <form class="form mt-3 mb-5" action="server/insert-tMiPerfilIPBUsuarios.php" method="POST">
                                        <h1 class="h5 mb-2 text-gray-800">Informaci&oacute;n Personal B&aacute;sica.</h1>
                                        <input type="hidden" name="id" value="<?php echo $idEmpresa ?>">
                                        <input type="hidden" name="idU" value="<?php echo $idVerUsuario ?>">

                                        <?php
                                            $dataPerfil = mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_empresa = $idEmpresa AND id_usuario = $idVerUsuario");
                                            $dataU = mysqli_fetch_assoc($dataPerfil);

                                            $dataUsuario = mysqli_query($conexion, "SELECT * FROM usuarios WHERE id_empresa = $idEmpresa AND id_usuario = $idVerUsuario");
                                        ...
                                        <div class="row pt-3 pb-4">
                                            ...
                                            <div class="col-3 pt-2">
                                                ...
                                                <select class="form-control" name="genero">
                                                    <?php 
                                                        $consulta = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_usuario = $idVerUsuario"));
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="IPS">
                                    ...
                                    <form class="form mt-3 mb-5" action="server/insert-tMiPerfilIPSUsuarios.php" method="POST">
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="IDE">
                                    ...
                                    <form class="form mt-3 mb-5" action="server/insert-tMiPerfilIDEUsuarios.php" method="POST">
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="IL">
                                    ...
                                    <form class="form mt-3 mb-5" action="server/insert-tMiPerfilILUsuarios.php" method="POST">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-6">
                                                ...
                                                <select class="form-control" id="idDepartamento" name="equipoAreaDepartamento" onclick="cargarPuestos();">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select class="form-control" id="puestos" name="cargoPuesto">
                                            ...
                                            <div class="col-3 pt-2">
                                                ...
                                                <input type="date" class="form-control" name="fechaIngreso" placeholder="Fecha De Ingreso" value="<?php echo $dataU['il_fecha_ingreso'] ?>" required>
                                            </div>
                                            <div class="col-3 pt-2">
                                                <small>Fecha De Alta De IMSS *</small>
                                                <input type="date" class="form-control" name="fechaAltaIMSS" placeholder="Fecha De Alta De IMSS" value="<?php echo $dataU['il_fecha_alta_imss'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="row pb-4">
                                            <div class="col-6 pt-2">
                                                <small>Nombre De Banco</small>
                                                <input type="text" class="form-control" name="nombreBanco" placeholder="Nombre De Banco" value="<?php echo $dataU['il_nombre_banco'] ?>" onkeyup="mayusculas(this)" maxlength="50">
                                            </div>
                                            <div class="col-3 pt-2">
                                                <small>N&uacute;mero De Cuenta</small>
                                                <input type="text" class="form-control" name="numeroCuenta" placeholder="N&uacute;mero De Cuenta" value="<?php echo $dataU['il_no_cuenta'] ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="20">
                                            </div>
                                            <div class="col-3 pt-2">
                                                <small>Clabe Interbancaria</small>
                                                <input type="text" class="form-control" name="clabeInterbancaria" placeholder="Clabe Interbancaria" value="<?php echo $dataU['il_clabe_interbancaria'] ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="18">
                                            </div>
                                        </div>
...
<!-- ------------------------------------------------------------------------- -->
                                        ...
                                        <div class="row pb-4">
                                            <div class="col-3">
                                                ...
                                                <input type="date" class="form-control" name="fechaInicio" placeholder="Fecha De Ingreso" value="<?php echo $dataU['cl_fecha_inicio'] ?>" required>
                                            </div>
                                            <div class="col-3">
                                                <small>Fecha De Finalizaci&oacute;n</small>
                                                <input type="date" class="form-control" name="fechaFinalizacion" placeholder="Fecha De Finalizaci&oacute;n" value="<?php echo $dataU['cl_fecha_finalizacion'] ?>">
                                            </div>
                                            <div class="col-3">
                                                <small>Frecuencia De Pago</small>
                                                <select class="form-control" name="frecuenciaPago">
                                                    <?php 
                                                        $consulta = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_usuario = '$idU'"));
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="form-control" name="salarioDiario" placeholder="Salario Diario" value="<?php echo $dataU['cl_salario_diario'] ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="10">
                                            </div>
                                            <div class="col-6 pt-2">
...
<!-- ------------------------------------------------------------------------- -->
                                        ...
                                        <div class="row pb-4">
                                             <div class="col-6">
                                                ...
                                                <select class="form-control" id="idSupervisorAusencias" name="supervisorAusencias" onclick="cargarPuestoYCorreoSupervisor();">
                                            ...
                                            <div class="col-6" id="puestoCorreoSupervisor">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <small>Puesto</small>
                                                        <select class="form-control" name="puestoSupervisor">
                                                        ...
                                                        <!--<input type="text" class="form-control" name="puestoSupervisor" placeholder="Puesto" value="<?php //echo $dataU['a_puesto_supervisor'] ?>">-->
                                                    </div>
                                                    <div class="col-6">
                                                        <small>Correo Electr&oacute;nico</small>
                                                        <input type="text" class="form-control" name="correoElectronicoSupervisor" placeholder="Correo Electr&oacute;nico" value="<?php echo $dataU['a_correo_supervisor'] ?>" maxlength="75">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="BAJA">
                                    <!-- BAJA = Baja. -->
                                    <form class="form mt-3 mb-5" action="server/insert-tMiPerfilBAJAUsuarios.php" method="POST">
                                        <h1 class="h5 mb-2 text-gray-800">Baja.</h1>
                                        <input type="hidden" name="id" value="<?php echo $idEmpresa ?>">
                                        <input type="hidden" name="idU" value="<?php echo $idVerUsuario ?>">

                                        <?php
                                            $dataUsuario = mysqli_query($conexion, "SELECT * FROM usuarios_perfiles INNER JOIN usuarios ON usuarios.id_usuario = usuarios_perfiles.id_usuario WHERE usuarios_perfiles.id_empresa = $idEmpresa AND usuarios_perfiles.id_usuario = $idVerUsuario");
                                            $dataU = mysqli_fetch_assoc($dataUsuario);
                                        ?>

                                        <div class="row pb-4">
                                            <div class="col-4">
                                                <small>Fecha De Baja *</small>
                                                <input type="date" class="form-control" name="fechaBaja" placeholder="Fecha De Baja" value="<?php echo $dataU['baja_fecha_baja'] ?>" required>
                                            </div>
                                            <div class="col-4">
                                                <small>Motivo De Separaci&oacute;n *</small>
                                                <select class="form-control" name="motivoSeparacion" required>
                                                    <?php 
                                                        $consulta = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_usuario = $idVerUsuario"));
                                                    
                                                        if ($dataU['baja_motivo_separacion'] == 'renunciaVoluntaria') {
                                                    ?>
                                                            <option value="" disabled>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria" selected>Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo">Abandono De Trabajo</option>
                                                            <option value="despidoJustificado">Despido Justificado</option>
                                                            <option value="despidoInjustificado">Despido Injustificado</option>
                                                            <option value="defuncion">Defunci&oacute;n</option>
                                                    <?php
                                                        } elseif ($dataU['baja_motivo_separacion'] == 'abandonoTrabajo') {
                                                    ?>
                                                            <option value="" disabled>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria">Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo" selected>Abandono De Trabajo</option>
                                                            <option value="despidoJustificado">Despido Justificado</option>
                                                            <option value="despidoInjustificado">Despido Injustificado</option>
                                                            <option value="defuncion">Defunci&oacute;n</option>
                                                    <?php
                                                        } elseif ($dataU['baja_motivo_separacion'] == 'despidoJustificado') {
                                                    ?>
                                                            <option value="" disabled>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria">Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo">Abandono De Trabajo</option>
                                                            <option value="despidoJustificado" selected>Despido Justificado</option>
                                                            <option value="despidoInjustificado">Despido Injustificado</option>
                                                            <option value="defuncion">Defunci&oacute;n</option>
                                                    <?php
                                                        } elseif ($dataU['baja_motivo_separacion'] == 'despidoInjustificado') {
                                                    ?>
                                                            <option value="" disabled>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria">Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo">Abandono De Trabajo</option>
                                                            <option value="despidoJustificado">Despido Justificado</option>
                                                            <option value="despidoInjustificado" selected>Despido Injustificado</option>
                                                            <option value="defuncion">Defunci&oacute;n</option>
                                                    <?php
                                                        } elseif ($dataU['baja_motivo_separacion'] == 'defuncion') {
                                                    ?>
                                                            <option value="" disabled>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria">Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo">Abandono De Trabajo</option>
                                                            <option value="despidoJustificado">Despido Justificado</option>
                                                            <option value="despidoInjustificado">Despido Injustificado</option>
                                                            <option value="defuncion" selected>Defunci&oacute;n</option>
                                                    <?php
                                                        } else {
                                                    ?>
                                                            <option value="" disabled selected>Motivo De Separaci&oacute;n</option>
                                                            <option value="renunciaVoluntaria">Renuncia Voluntaria</option>
                                                            <option value="abandonoTrabajo">Abandono De Trabajo</option>
                                                            <option value="despidoJustificado">Despido Justificado</option>
                                                            <option value="despidoInjustificado">Despido Injustificado</option>
                                            ...
                                            <div class="col-4">
                                                <small>Recontrataci&oacute;n *</small>
                                                <select class="form-control" name="recontratacion" required>
                                                    <?php 
                                                        $consulta = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM usuarios_perfiles WHERE id_usuario = $idVerUsuario"));
                                                    
                                                        if ($dataU['baja_recontratacion'] == '1') {
                                                    ?>
                                                            <option value="" disabled>Recontrataci&oacute;n</option>
                                                            <option value="1" selected>Si</option>
                                                            <option value="2">No</option>
                                                    <?php
                                                        } elseif ($dataU['baja_recontratacion'] == '2') {
                                                    ?>
                                                            <option value="" disabled>Recontrataci&oacute;n</option>
                                                    ...
                                                    ?>
                                                            <option value="" disabled selected>Recontrataci&oacute;n</option>
                                                            <option value="1">Si</option>
                                                            <option value="2">No</option>
                                                    <?php
                                                        }
