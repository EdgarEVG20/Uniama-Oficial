<?php
	...
	error_reporting(0);
	if(isset($_POST['nombreRelojChecadorUsuarios']) && isset($_POST['id'])) {
		$id = $conexion->real_escape_string($_POST['id']);
		$q = $conexion->real_escape_string($_POST['nombreRelojChecadorUsuarios']);
		...
		while($fila= $buscar->fetch_assoc()) {
			...
			<tbody>
				<tr>
                    ...
                    <td>'.$nivel.'</td>
					<td class="btn-ver">
                        <a type="button" class="btn btn-success" href="adminVerChecadas.php?idU='.$idUsuarioEmpresa.'"><i class="fas fa-eye"></i></a>
                    </td>
				</tr>
			 </tbody>
			';
