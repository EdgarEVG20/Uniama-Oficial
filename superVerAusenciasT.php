<?php
    ...
    } elseif (isset($usuario) && $nivelUsuario == 3) {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php
                            //$res = mysqli_query($conexion, "SELECT ausencias.id_ausencia, ausencias.id_empresa, ausencias.id_usuario, ausencias.id_cat_ausencia, catalogo_ausencias.nombre, ausencias.motivo, ausencias.tipo, ausencias.fecha_inicio, ausencias.fecha_fin, ausencias.archivo_adjunto, ausencias.estatus FROM ausencias INNER JOIN catalogo_ausencias ON ausencias.id_cat_ausencia = catalogo_ausencias.id_ausencia INNER JOIN usuarios_perfiles ON usuarios_perfiles.a_supervisor_ausencias = $idUsuario WHERE ausencias.id_empresa = $idEmpresa AND  ORDER BY ausencias.id_ausencia DESC");
                            //$res = mysqli_query($conexion, "SELECT ausencias.id_ausencia, ausencias.id_empresa, ausencias.id_usuario, ausencias.id_cat_ausencia, catalogo_ausencias.nombre, ausencias.motivo, ausencias.tipo, ausencias.fecha_inicio, ausencias.fecha_fin, ausencias.archivo_adjunto, ausencias.estatus FROM ausencias INNER JOIN catalogo_ausencias ON ausencias.id_cat_ausencia = catalogo_ausencias.id_ausencia INNER JOIN usuarios_perfiles ON ausencias.id_usuario = usuarios_perfiles.id_usuario WHERE ausencias.id_empresa = $idEmpresa AND usuarios_perfiles.a_supervisor_ausencias = $idUsuario ORDER BY ausencias.id_ausencia;");
                            $res = mysqli_query($conexion, "SELECT ausencias.id_ausencia, ausencias.id_empresa, ausencias.id_usuario, usuarios.nombre AS nombreU, ausencias.id_cat_ausencia, catalogo_ausencias.nombre, ausencias.motivo, ausencias.tipo, ausencias.fecha_inicio, ausencias.fecha_fin, ausencias.archivo_adjunto, ausencias.estatus FROM ausencias INNER JOIN usuarios ON ausencias.id_usuario = usuarios.id_usuario INNER JOIN catalogo_ausencias ON ausencias.id_cat_ausencia = catalogo_ausencias.id_ausencia INNER JOIN usuarios_perfiles ON ausencias.id_usuario = usuarios_perfiles.id_usuario WHERE ausencias.id_empresa = $idEmpresa AND usuarios_perfiles.a_supervisor_ausencias = $idUsuario ORDER BY ausencias.id_ausencia;");
                        ?>
                                    ...
                                    <div class="modal fade" id="modal-edit-tAusencia<?php echo $data['id_ausencia'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="server/update-superTAusencia.php" method="POST">
...
<?php
    } elseif (isset($usuario) && $nivelUsuario == 1 || $nivelUsuario == 2 || $nivelUsuario == 4) {
