        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Formulario -->
                    <form class="form mt-3 mb-5" action="server/insert-ausencias.php" method="POST">
                        <div class="row pt-3 pb-4">
                            <div class="col-12">
                                <input type="text" class="form-control" name="nombre" placeholder="Nombre" required onkeyup="mayusculas(this)" maxlength="30">
                            </div>
                            <!--<div class="col">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php
                            $res = mysqli_query($conexion, "SELECT * FROM _cat_ausencias ORDER BY nombre ASC")
                        ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="btn-modificar">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit-company<?php echo $data['id_ausencia']; ?>"><i class="fas fa-user-edit"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>

                                    <!-- Modal Para Modificar Ausencia -->
                                    <div class="modal fade" id="modal-edit-company<?php echo $data['id_ausencia']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="server/update-ausencias.php" method="POST">
